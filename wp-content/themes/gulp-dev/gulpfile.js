...
gulp.task('js', function(){
	return gulp.src(['node_modules/bootstrap/dist/js/bootstrap.min.js','node_modules/jquery/dist/jquery.min.js','node_modules/popper.js/dist/umd/popper.min.js','node_modules/owl.carousel/docs/assets/owlcarousel/owl.carousel.js','node_modules/jquery-circle-progress/dist/circle-progress.js','node_modules/jquery.counterup/jquery.counterup.js','node_modules/wowjs/dist/wow.js','node_modules/aos/dist/aos.js','node_modules/jquery.animate-number/jquery.animateNumber.min.js','node_modules/jquery.easing/jquery.easing.js','node_modules/jquery.stellar/jquery.stellar.js','node_modules/waypoints/lib/jquery.waypoints.js','node_modules/jquery-migrate/dist/jquery-migrate.min.js','node_modules/scrollax/scrollax.js','node_modules/magnific-popup/dist/jquery.magnific-popup.js', js + '*.js'])
  .pipe(gulp.dest(js))
  // .pipe(browserSync.stream());
});
...
// Watch Sass & server
gulp.task('serve',['sass','styles','bootstrap','vendorbs','js','images','fonts','icomoon'], function(){
  browserSync.init({
			open: 'external',
			proxy: 'localhost/stories/',
			port: 9991
  });
  gulp.watch(root + '**/*.scss' ,['sass','styles','bootstrap']);
  gulp.watch(js + '**/*.js',['js']);
